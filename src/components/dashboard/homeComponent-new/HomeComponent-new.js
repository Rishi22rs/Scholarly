  ...
  return (
    <div className="home">
      <div className="home__modal">
        ...
        >
          <div className="modal__container">
            ...
            <div className="modal__sec2 modal__sec2-log">
        ...
        >
          <div className="modal__container">
            ...
            <div className="modal__sec2 modal__sec2-log">
              <CloseRoundedIcon onClick={() => setOpenSignup(false)} />
              <div className="modal__content2">
                <div className="google__login">
                  <img src={googleLogo} alt="gl" />
                  <p>Continue with Google</p>
      ...
      <div className="home_nav_bar">
        <button className="home__login" onClick={() => setOpen(true)}>
          Log In
        </button>
        <button
      ...
      <section className="home_firstsection">
        <div className="sec1_content">
          ...
          <p>
            Student Nation is creating a future where it is exciting and fair to
      ...
      <section className="home_secondsection">
        <div className="sec2_content1">
          ...
          <p>
            ...
            Student Nation enables collaboration between companies, universities
            and their students by creating an ecosystem of opportunities where
        ...
        <div className="sec2_content2">
          ...
          <p>
            ...
            make ends meet while 72% of recruiters struggling to find qualified
            candidates.
          </p>
        </div>
      ...
      <section className="home_thirdsection">
        <div className="for_cards_container">
          ...
          <div className="for_card">
            ...
            <h4>For Employers</h4>
            <p>
              We partner with employers to help companies discover the untapped
              talent.
            </p>
          </div>
          <div className="for_card">
