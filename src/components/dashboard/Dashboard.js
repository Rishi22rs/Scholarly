...
import ProjectsForYou from "./ProjectsForYou/ProjectsForYou";
import ProjectsForYouDescription from "./ProjectsForYou/ProjectsForYouDescription";
  ...
  const steps = [
    {
      ...
      content: () => <p>search for new companies here!</p>,
      style: {
        backgroundColor: "#fff",
        padding: "20px 60px",
        margin: "10px 0",
    ...
    },
    {
      ...
      content: () => (
        <p>
          Many companies organises events from time to time. Check those out!
        </p>
      ),
      style: {
        backgroundColor: "#fff",
    ...
    },
    {
      ...
      content: () => <p>Find job openings of the day, here</p>,
      style: {
        backgroundColor: "#fff",
        padding: "20px 60px",
        margin: "10px 0",
    ...
    {
      selector: ".jobs-item",
      content: () => <p>Job openings as per your personal preferences</p>,
      style: {
        backgroundColor: "#fff",
        padding: "20px 60px",
        margin: "10px 0",
    ...
    },
    {
      ...
      content: () => (
        <p>
          Complete assignments related to your domain to increase your chances
          of getting short listed for the job
        </p>
      ),
      style: {
        backgroundColor: "#fff",
    ...
    },
    {
      ...
      content: () => (
        <p>
          Maintain your profile so that employers can get to know your skills
          and experiences
        </p>
      ),
      style: {
    ...
    },
    {
      ...
      content: () => <p>filter opportunities with custom preferences</p>,
      style: {
        backgroundColor: "#fff",
        padding: "20px 60px",
        margin: "10px 0",
    ...
    },
    {
      ...
      content: () => <p>Add external profile links to add to your portfolio</p>,
      style: {
        backgroundColor: "#fff",
        padding: "20px 60px",
        margin: "10px 0",
      ...
      <div className="main-dash-container">
        ...
        <div className="dash-container">
          ...
          <div className="dash__component">
            ...
            <Route
              exact
              path="/dashboard/utilityboard"
              component={UtilityBoard}
            />
            <Route
              exact
              path="/dashboard/utilityboard/projectDescription"
              component={ShowCalender}
            />
            ...
            <Route
              ...
              component={ProjectsForYou}
            />
            <Route
              exact
              path="/dashboard/new-projects/:id"
              component={ProjectsForYouDescription}
            />
            ...
            <Route
              ...
              render={(props) => (
                <NewProfile {...props} setIsTourOpen={setIsTourOpen} />
              )}
            />
            <Route
              exact
